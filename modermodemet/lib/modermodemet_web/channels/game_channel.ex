defmodule ModermodemetWeb.GameChannel do
  use ModermodemetWeb, :channel
  alias ModermodemetWeb.Presence
  ...
  """
  defp should_broadcast?(%{"broadcast" => true} = params, socket, event),
    do: broadcast!(socket, event, params)
